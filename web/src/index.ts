// Public package entry — re-exports user pages and shared subset.
//
// aikey-control/web is published as the npm package `aikey-control-web` so
// downstream consumers can compose user-side SPA fragments without
// duplicating source.
//
