...
interface ActionDialogProps {
   ...
   * THIS object". Forcing one shape onto both would have meant asking somebody
   * to retype a partner's name to acknowledge a paragraph.
   */
...
export function ActionDialog({
  ...
  // Colours come from the theme tokens (light-theme work, no-raw-neutral fence);
  // `extraDisabled` is this change's addition. Both sides of the merge are kept.
